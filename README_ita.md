...
Servizio puramente software (nodo di ingestione) - senza hardware/firmware/os propri, rimossi dal template (vedi la convenzione dell'ecosistema in `SONNET/_papelera/`).
